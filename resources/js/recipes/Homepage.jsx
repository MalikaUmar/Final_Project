    ...
    return (
        <>
            ...
            <div className='upper_heading'>
                Dive in the world's greatest cuisines </div>
            ...
            <div className='main'>
                <div className="navigation_column">
                    <nav>
                        ...
                        <a href="#">Serbian cuisine</a><br></br>
                        <a href="#">Indian cuisine</a><br></br>
                        <a href="#">Create a meal with what you have in a fridge</a> <br></br>
                        <a href="#">Shops that can help</a><br></br>
                    </nav>
                </div>
                ...
                <div className="cuisines_wrapper" >
                    <div className="navigation_cuisine">
                        ...
                        <img className="icons_navigation" src="/public/images/asparagus-2169305_640.jpg" alt="" />
                    </div>

                    <div className="navigation_cuisine">
                        <a href="#">Balkan cuisine</a>
                        <img className="icons_navigation" src="public/images/pancakes-2291908_640.jpg" alt="" />
                    </div>

                    <div className="navigation_cuisine">
                        <a href="#">Indian cuisine </a>
                        <img className="icons_navigation" src="public/images/pasta-1181189_640.jpg" />
                    </div>
