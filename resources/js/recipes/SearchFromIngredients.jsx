...
export default function SearchFromIgredinents(){
    ...
    return(
     <main className="search_main">
        ...
        />
       <button className="search_button" onClick={handleSubmit}>Submit</button>

       {
        ...
        <>  <div className="search_meal">
            <div >
                ...
                <img className="search_img"src={meal.image} alt="the photo of the meal you choused" />
            ...
            <div>
                <ul>
                    ...
                    meal.ingredients.map((ingredient, i) => (
                        <li key={i}>{ingredient.name}:{ingredient.pivot.measure}</li>
                    ))
                    }
                </ul>
            </div>
