    ...
    return (
        ...
        <div className="IndianRecepie-container">
            ...
            <div className="category-image-container">
                <img className="category-image" src="https://marketplace.canva.com/NqqlA/MAFmARNqqlA/1/s2/canva-indian-food-MAFmARNqqlA.jpg" alt="" />
            </div>
            <h1 className="container-cardsList_heading">Explore Indian Recipes</h1>
