...
function Login() {
  ...
  return (
    ...
    <input className="login_input" type="email" name="email" value={ values.email } onChange={ handleChange } placeholder="Email"/>
    </div>
     
    <div>
      {loginErrors.password ? <p>{loginErrors.password}</p> : '' }
    <input className="login_input" type="password" name="password" value={ values.password } onChange={ handleChange } placeholder="Password" />
    </div>
