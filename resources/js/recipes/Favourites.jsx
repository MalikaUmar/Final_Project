...
const removeRecipe = async(recipe_id)=>{
    const response = await fetch(`/api/removeFavourites/${user.id}/${recipe_id}`);
    const data = await response.json();
    displayFavourites()
  ...
  return (
    ...
    <div className="favourites-container">
        ...
        <div className="favourites-container_heading">
            ...
            <div className="user-info">
              <FontAwesomeIcon icon={faUser} className="user-icon"/><br />
                ...
                favourites.map(item=>{
                    return(
                        ...
                        <div className="cards">
                              ...
                              <div className="card-remove" onClick={()=>{removeRecipe(item.id) }}>
    ...
    <div className="favouritsSecond-container">
        <div className="favouritsSecond-container_image">
            <img src="https://marketplace.canva.com/NqqlA/MAFmARNqqlA/1/s2/canva-indian-food-MAFmARNqqlA.jpg" alt="" />
        </div>
        <div className="favouritsSecond-container_content">
            <h1>Login or Signup to see your Favourites Recipes</h1>
            <Link to={'/login'} className="favouritsSecond-container_link">Login</Link>
            <Link to={'/register'} className="favouritsSecond-container_link">Signup</Link>
        </div>
